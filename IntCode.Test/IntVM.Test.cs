...
public class IntVMTest {
    ...
    public void Add_WithPositionMode() {
        var vm = new IntVM(new[] { 1, 4, 5, 6, 10, 20, 0 });
        vm.Step();
    ...
    public void Add_WithImmediateMode() {
        var vm = new IntVM(new[] { 11_01, 4, 5, 6, 10, 20, 0 });
        vm.Step();
    ...
    public void Add_WithMixedParamMode1() {
        var vm = new IntVM(new[] { 10_01, 4, 5, 6, 10, 20, 0 });
        vm.Step();
    ...
    public void Add_WithMixedParamMode2() {
        var vm = new IntVM(new[] { 1_01, 4, 5, 6, 10, 20, 0 });
        vm.Step();
    ...
    public void Add_WithInvalidTargetParamMode() {
        var vm = new IntVM(new[] { 101_01, 4, 5, 6, 10, 20, 0 });
    ...
    public void Mult_WithImmediateMode() {
        var vm = new IntVM(new[] { 11_02, 4, 5, 6, 10, 20, 0 });
        vm.Step();
    ...
    [Test]
    public void Exit() {
        var vm = new IntVM(new[] { 99, 1, 4, 5, 6, 10, 20, 0 });
        vm.Run();
